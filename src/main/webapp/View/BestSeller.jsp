...
<script>
	function gobook(){
		location.href="BestSeller.jsp";
	}
	function gofbook(){
		location.href="FBestSeller.jsp";
	}
	function goebook(){
		location.href="EBestSeller.jsp";
	}
	...
	function gobestseller(mgb, code, orderClick){
		var mallGb = 'KOR';
		var range = '1';
		var kind = '0';
		var kyoboTotalYn = 'N';
		...
		var pagePath = "/lms/View/BestSeller.jsp?mallGb="+ mallGb +"&linkClass="+ code;
		if(kyoboTotalYn == 'Y'){//kyoboTotalYn 은 eBook에서만 사용. 없을경우 파라미터 넘기지 않음.(혼란방지)
			document.location.href =  pagePath + "&range="+ range +"&kind="+ kind +"&kyoboTotalYn="+ kyoboTotalYn +"&orderClick="+ orderClick;
		}else{
			document.location.href =  pagePath + "&range="+ range +"&kind="+ kind +"&orderClick="+ orderClick;
		}
	}
</script>
<header>
...
<content>
	...
	<div class="d1">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:gobestseller('KOR', 'A', 'DAa')">종합</a>&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:gobestseller('KOR', 'B', 'DAa')">인문/사회</a>&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:gobestseller('KOR', 'C', 'DAa')">과학</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:gobestseller('KOR', 'D', 'DAa')">소설</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:gobestseller('KOR', 'E', 'DAa')">컴퓨터</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:gobestseller('KOR', 'F', 'DAa')">역사</a><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</div><br>
